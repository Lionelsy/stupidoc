...
var BIGBROTHER_HOST = 'http://bigbrother.dockerlab.alipay.net';
  ...
  _createClass(Reminder, [{
    ...
    value: function getBigfishReportData() {
      ...
      return {
        needReport: true,
        // 有锁版本，进行上报
        data: _objectSpread({}, this.getCommonReportData(), {
          version: version,
          pkg: pkg
        })
      };
    ...
    value: function getOtherBuildToolReportData(name) {
      ...
      try {
        ...
        for (var _i = 0; _i < depNeedReport.length; _i++) {
          var dep = depNeedReport[_i];
